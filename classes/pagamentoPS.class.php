...
class PagamentoPS extends BD{
    ...
    public function Pagamento($cliente = array(), $pedido = array(), $produtos = array()) {
        ...
        $dados['senderName']    = $cliente['nome'] .' ' . $cliente['sobrenome'];
        $dados['senderAreaCode']  = $cliente[""];
        $dados['senderPhone']    = $cliente['telefone'];
        $dados['senderEmail']    = $cliente['email'];
        $dados['senderCPF']    = $cliente['cpf'];        
        $dados['shippingAddressStreet']   = $cliente['logradouro'];
        $dados['shippingAddressNumber']   = $cliente['numero'];
        //$dados['shippingAddressComplement'] = '';
        $dados['shippingAddressDistrict'] = $cliente['bairro'];
        $dados['shippingAddressPostalCode']  = $cliente['cep'];
        $dados['shippingAddressCity']    = $cliente['cidade'];
        $dados['shippingAddressState']    = strtoupper($cliente['uf']); 
        ...
        foreach ($produtos as $item):
             ...
             $dados['itemId'.$i]          = $item['id'];
             $dados['itemDescription'.$i] = $item['titulo'];
             $dados['itemAmount'.$i]      = $item['valor_atual'];
...
//        $dados['itemWeight1'] = '1000';
    ...
    public function PagamentoITENS($cliente = array(), $pedido = array(), $produtos = array()) {
        ...
        $dados['shippingType'] = '3'; // sem especificar
        $dados['shippingAddressCountry']   = 'BRA';
        $dados['shippingCost']    = $_SESSION['valor_frete'; // valor do frete
